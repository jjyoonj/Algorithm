...
### 개념
 <p>이차원 배열로 100*100 도화지를 그린다고 생각. 이때 다 0으로 입력함.</p>
 <p>1*1 정사각형의 왼쪽 아래 모서리가 입력 점이라고 생각하자.</p>
 <p>넓이를 array에 1로 입력을 해서 총 개수 세기를 하면 원하는 답이 나온다.</p>
